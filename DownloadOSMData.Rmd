...
# Directory for images used
knitr::include_graphics('/Users/heba/Documents/GitHub/lim-lab')
```
...
```{r, read-buildings-roads-trees, message=FALSE, warning=FALSE, eval=FALSE}
# read roads file
