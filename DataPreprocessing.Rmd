...
# read csv files
```{r, read-csv-files, eval=FALSE}
purpleair <- fread(paste0(purpleair_directory, "/purple_air_sanfran_", purpleairformat, ".csv"))
uber_data <- fread(paste0(uber_directory, "/uber-", uberformat, ".csv"))
```
