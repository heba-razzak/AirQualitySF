...
```{r, cumulative-distribution-recent-plot}
...
```{r}
ggplot(purpleair_filtered_subset, aes(x = time_stamp, y = pm2.5_atm)) +
  geom_line() +
  labs(
    x = "Date", 
    y = "PM2.5 ATM", 
...
ggplot(purpleair_filtered_subset, aes(x = time_stamp, y = pm2.5_atm, group = sensor_index, color = as.factor(sensor_index))) +
  geom_line() +
  labs(
    x = "Date", 
    y = "PM2.5 ATM", 
...
p <- ggplot(purpleair_filtered_subset, 
            aes(x = time_stamp, y = pm2.5_atm, group = sensor_index, color = as.factor(sensor_index))) +
  geom_line() +
  labs(
    x = "Date", 
    y = "PM2.5 ATM", 
