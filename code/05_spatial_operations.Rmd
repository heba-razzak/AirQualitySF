...
filepath <- file.path("data", "processed", "wildfires_pa.csv")
if (!file.exists(filepath)) {
  # Read purple air data
  filepath_pa <- file.path("data", "raw", "purpleair_2018-01-01_2019-12-31.csv")
  purpleair_data <- read.csv(filepath_pa)
