...
``` r
# API configuration
api_key = readr::read_file(here("code", "inputs", "purpleair_key.txt"))
...
filepath <- here("code", "data", "raw", filename)
...
if (!file.exists(filepath)) {
  ...
  purpleair_data <- fread(filepath)
}

# Save sensor metadata
filepath <- here("code", "data", "raw", "pa_sensors.csv")
if (!file.exists(filepath)) {
...
|:-------------:|:---------:|:-------------------------------------:|
| sensor_index  |  numeric  |  PurpleAir sensor unique identifier   |
...
|---:|:---|:---|---:|:---|
| 182 | 2016-08-01 | 2025-01-29 | 0 | POINT (-123.7423 49.16008) |
| 195 | 2016-08-01 | 2025-01-29 | 0 | POINT (-124.1288 41.06) |
| 221 | 2016-08-08 | 2025-01-29 | 0 | POINT (-117.4153 33.99952) |
...
| Column | Type | Description |
|:--:|:--:|:--:|
| time_stamp | POSIXct | UTC (Unix) time stamp for that row of data. |
...
``` r
img_path <- here("docs", "plots", "pa-sensors-map.png")

if (!file.exists(img_path)) {
  map_path <- here("docs", "maps", "pa-sensors-map.html")
  m <- leaflet() %>%
